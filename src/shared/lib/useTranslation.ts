...
const translations = {
  en: {
    ...
    pattern_label: 'FACTION PATTERN',
    pattern_none: 'None',
    pattern_stripes: 'Stripes',
    pattern_dots: 'Dots',
    pattern_grid: 'Grid',
    pattern_horizontal: 'Lines',
    pattern_diamonds: 'Diamonds',
    pattern_waves: 'Waves',
    pattern_dashed: 'Dashed',
    profile_stats_sectors: 'Sectors',
    profile_btn_customize: 'Customize Appearance',
    profile_appearance_title: 'Faction Appearance',
  ...
  ru: {
    ...
    pattern_label: 'УЗОР ФРАКЦИИ',
    pattern_none: 'Нет',
    pattern_stripes: 'Полосы',
    pattern_dots: 'Точки',
    pattern_grid: 'Сетка',
    pattern_horizontal: 'Линии',
    pattern_diamonds: 'Ромбы',
    pattern_waves: 'Волны',
    pattern_dashed: 'Пунктир',
    profile_stats_sectors: 'Секторы',
    profile_btn_customize: 'Настроить внешний вид',
    profile_appearance_title: 'Внешность Фракции',
